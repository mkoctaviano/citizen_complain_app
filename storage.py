...
def 결과_등록(
    ...
    router = 기타.get("router", {}) or {}

    기타["상위부서Top2"] = router.get("상위부서Top2", [])
    기타["상위부서_후보TopK"] = router.get("상위부서_후보TopK", [])
    기타["부서_후보TopK"] = router.get("부서_후보TopK", [])
    기타["공통확인_사유"] = router.get("공통확인_사유", "")
